...
public class CardTrick {
    ...
    private final Comparator<Card> displayComparator = Comparator
            ...
            .thenComparing(Card::getSuit)                  // or (c) -> c.getSuit()
    ...
    public static void main(String[] args) {
        ...
        //TODO (optional: shuffle the deque(s))
    ...
    private void tallyPile(Collection<Card> pile, Suit.Color color) {
        ...
        long count = pile
                .stream()                                               //starts a stream (assembly line)
                .filter((c) -> c.getSuit().getColor() == color)         //filters cards that do not equal given color argument, argument must be a boolean
                .count();                                               //count the cards after filtering
